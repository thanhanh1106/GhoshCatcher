...
namespace Unicorn
{
    ...
    public class UnicornDataLevel : IDataLevel, ILevelInfo
    {
        ...
        [JsonProperty] private Dictionary<LevelType, LevelTypeInfo> levelTypesIndex; // thằng này hiện tại chỉ có 1 phần tử do LevelType mới có 1 kiểu 
        ...
        private Dictionary<LevelType, LevelTypeInfo> LevelTypesIndex
        {
            get
            {
                ...
                {
                    // duyệt lại tất cả các levelType và khởi tạo levelInfo dựa trên các levelType chưa khởi tạo levelInfo
        ...
        public UnicornDataLevel(LevelConstraint levelConstraint)
        {
            ...
            // duyệt qua tất cả các levelType và khởi tạo levelInfo dựa trên tất cả levelType
        ...
        /// <summary>
        /// Set lại level type, nếu lựa chọn tăng level sẽ tự động tăng level thêm 1
        /// </summary>
        ...
        // tự động tăng level, chuyển levelType và save lại 
